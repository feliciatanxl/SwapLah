...
def _active_listing_search_filters(keyword="", category="", condition="", price_type=""):
...
def search_active_listings(keyword="", category="", condition="", price_type=""):
    """Return active listings matching search, category, condition, and price type filters."""
    conn = get_db_connection()
