...
All DB calls are monkeypatched at the route module level.
"""
import pytest
import app.routes.offers as offers_module
...
def test_unit_get_received_offers_success(client, monkeypatch):
    ...
    login_as(client, 1)
    monkeypatch.setattr(offers_module, "get_offers_for_seller", lambda sid: FAKE_OFFERS)
...
def test_unit_get_received_offers_empty(client, monkeypatch):
    ...
    login_as(client, 1)
    monkeypatch.setattr(offers_module, "get_offers_for_seller", lambda sid: [])
...
def test_unit_accept_offer_success(client, monkeypatch):
    ...
    login_as(client, 1)
    monkeypatch.setattr(offers_module, "get_offer_by_id", lambda oid: FAKE_OFFER_PENDING)
    monkeypatch.setattr(offers_module, "get_listing_owner", lambda lid: 1)
    monkeypatch.setattr(offers_module, "accept_offer", lambda oid: FAKE_OFFER_ACCEPTED)
...
def test_unit_accept_offer_not_found(client, monkeypatch):
    ...
    login_as(client, 1)
    monkeypatch.setattr(offers_module, "get_offer_by_id", lambda oid: None)
...
def test_unit_accept_offer_already_rejected(client, monkeypatch):
    ...
    login_as(client, 1)
    monkeypatch.setattr(offers_module, "get_offer_by_id", lambda oid: FAKE_OFFER_REJECTED)
    monkeypatch.setattr(offers_module, "get_listing_owner", lambda lid: 1)
...
def test_unit_reject_offer_success(client, monkeypatch):
    ...
    monkeypatch.setattr(offers_module, "get_offer_by_id", lambda oid: FAKE_OFFER_PENDING)
    monkeypatch.setattr(offers_module, "get_listing_owner", lambda lid: 1)
    monkeypatch.setattr(offers_module, "reject_offer", lambda oid: FAKE_OFFER_REJECTED)
...
def test_unit_reject_does_not_touch_other_offers(client, monkeypatch):
    ...
    monkeypatch.setattr(offers_module, "reject_offer", fake_reject)
